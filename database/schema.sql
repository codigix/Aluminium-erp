...
CREATE TABLE IF NOT EXISTS sales_orders (
  ...
  status ENUM('CREATED', 'DESIGN_IN_REVIEW', 'DESIGN_APPROVED', 'DESIGN_QUERY', 'QUOTATION_SENT', 'BOM_SUBMITTED', 'BOM_APPROVED', 'PROCUREMENT_IN_PROGRESS', 'MATERIAL_PURCHASE_IN_PROGRESS', 'MATERIAL_READY', 'IN_PRODUCTION', 'PRODUCTION_COMPLETED', 'QC_IN_PROGRESS', 'QC_APPROVED', 'QC_REJECTED', 'READY_FOR_SHIPMENT', 'SHIPPED', 'CLOSED') DEFAULT 'CREATED',
...
CREATE TABLE IF NOT EXISTS quotations (
  ...
  status ENUM('DRAFT', 'SENT', 'RECEIVED', 'REVIEWED', 'CLOSED', 'PENDING', 'EMAIL_RECEIVED') DEFAULT 'DRAFT',
  valid_until DATE,
...
CREATE TABLE IF NOT EXISTS purchase_orders (
  ...
  vendor_id INT NOT NULL,
  sales_order_id INT,
  status ENUM('DRAFT', 'PO_REQUEST', 'ORDERED', 'SENT', 'ACKNOWLEDGED', 'RECEIVED', 'PARTIALLY_RECEIVED', 'CLOSED', 'COMPLETED', 'FULFILLED', 'APPROVED', 'PENDING_PAYMENT', 'PAID') DEFAULT 'ORDERED',
  total_amount DECIMAL(14, 2) DEFAULT 0,
...
('View Vendors', 'VENDOR_VIEW', 'vendors', 'read', 'View vendor data'),
('Edit Vendors', 'VENDOR_EDIT', 'vendors', 'update', 'Edit vendor data'),
('View Quotations', 'QUOTATION_VIEW', 'quotations', 'read', 'View vendor quotations'),
('Edit Quotations', 'QUOTATION_EDIT', 'quotations', 'update', 'Edit vendor quotations'),
('View Purchase Orders', 'PURCHASE_ORDER_VIEW', 'purchase_orders', 'read', 'View purchase orders'),
('Create Purchase Order', 'PURCHASE_ORDER_CREATE', 'purchase_orders', 'create', 'Create purchase orders'),
('Edit Purchase Order', 'PURCHASE_ORDER_EDIT', 'purchase_orders', 'update', 'Edit purchase orders'),
('Delete Purchase Order', 'PURCHASE_ORDER_DELETE', 'purchase_orders', 'delete', 'Delete purchase orders'),
('View GRNs', 'GRN_VIEW', 'grns', 'read', 'View GRNs'),
('Create GRN', 'GRN_CREATE', 'grns', 'create', 'Create GRNs'),
('Edit GRN', 'GRN_EDIT', 'grns', 'update', 'Edit GRNs'),
('Delete GRN', 'GRN_DELETE', 'grns', 'delete', 'Delete GRNs'),
('View Stock', 'STOCK_VIEW', 'stock', 'read', 'View stock balances and ledger'),
('Manage Stock', 'STOCK_MANAGE', 'stock', 'all', 'Manage stock entries and adjustments'),
('View QC', 'QC_VIEW', 'qc_inspections', 'read', 'View QC inspections'),
('Create QC', 'QC_CREATE', 'qc_inspections', 'create', 'Create QC inspections'),
('Edit QC', 'QC_EDIT', 'qc_inspections', 'update', 'Edit QC inspections'),
('View BOM', 'BOM_VIEW', 'bom', 'read', 'View Bill of Materials'),
('Manage BOM', 'BOM_MANAGE', 'bom', 'all', 'Create and edit Bill of Materials'),
('View Production', 'PROD_VIEW', 'production', 'read', 'View production plans and job cards'),
('Manage Production', 'PROD_MANAGE', 'production', 'all', 'Manage production processes'),
  ('View Design', 'DESIGN_VIEW', 'design', 'read', 'View designs and drawings'),
  ('Manage Design', 'DESIGN_MANAGE', 'design', 'all', 'Create and edit designs and drawings');
