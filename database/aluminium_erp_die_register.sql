...
--
-- Table structure for table `die_register`
--

DROP TABLE IF EXISTS `die_register`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `die_register` (
  ...
  CONSTRAINT `die_register_ibfk_1` FOREIGN KEY (`tool_id`) REFERENCES `tool_master` (`tool_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `die_register`
--

LOCK TABLES `die_register` WRITE;
/*!40000 ALTER TABLE `die_register` DISABLE KEYS */;
/*!40000 ALTER TABLE `die_register` ENABLE KEYS */;
UNLOCK TABLES;
