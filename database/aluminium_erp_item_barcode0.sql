...
CREATE TABLE `item_barcode` (
  ...
  `barcode_name` varchar(255) DEFAULT NULL,
  `barcode_type` varchar(50) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`barcode_id`),
  UNIQUE KEY `barcode` (`barcode`),
  KEY `idx_item_code` (`item_code`),
  CONSTRAINT `item_barcode_ibfk_1` FOREIGN KEY (`item_code`) REFERENCES `item` (`item_code`) ON DELETE CASCADE
...
LOCK TABLES `item_barcode` WRITE;
/*!40000 ALTER TABLE `item_barcode` DISABLE KEYS */;
/*!40000 ALTER TABLE `item_barcode` ENABLE KEYS */;
UNLOCK TABLES;
