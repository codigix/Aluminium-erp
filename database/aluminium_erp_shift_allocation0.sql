...
DROP TABLE IF EXISTS `shift_allocation`;
...
CREATE TABLE `shift_allocation` (
  ...
  CONSTRAINT `shift_allocation_ibfk_1` FOREIGN KEY (`employee_id`) REFERENCES `employee_master` (`employee_id`)
...
LOCK TABLES `shift_allocation` WRITE;
/*!40000 ALTER TABLE `shift_allocation` DISABLE KEYS */;
/*!40000 ALTER TABLE `shift_allocation` ENABLE KEYS */;
UNLOCK TABLES;
