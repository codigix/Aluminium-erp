...
CREATE TABLE `purchase_invoice_item` (
  ...
  PRIMARY KEY (`id`),
  KEY `purchase_invoice_no` (`purchase_invoice_no`),
  KEY `item_code` (`item_code`),
  CONSTRAINT `purchase_invoice_item_ibfk_1` FOREIGN KEY (`purchase_invoice_no`) REFERENCES `purchase_invoice` (`purchase_invoice_no`),
  CONSTRAINT `purchase_invoice_item_ibfk_2` FOREIGN KEY (`item_code`) REFERENCES `item` (`item_code`)
