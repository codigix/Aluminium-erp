...
CREATE TABLE `stock` (
  ...
  CONSTRAINT `stock_ibfk_1` FOREIGN KEY (`item_code`) REFERENCES `item` (`item_code`),
  CONSTRAINT `stock_ibfk_2` FOREIGN KEY (`warehouse_code`) REFERENCES `warehouse` (`warehouse_code`)
