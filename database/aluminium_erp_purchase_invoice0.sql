...
CREATE TABLE `purchase_invoice` (
  ...
  PRIMARY KEY (`purchase_invoice_no`),
  KEY `po_no` (`po_no`),
  KEY `grn_no` (`grn_no`),
  KEY `idx_invoice_date_supplier` (`supplier_id`,`invoice_date`),
  CONSTRAINT `purchase_invoice_ibfk_1` FOREIGN KEY (`supplier_id`) REFERENCES `supplier` (`supplier_id`),
  CONSTRAINT `purchase_invoice_ibfk_2` FOREIGN KEY (`po_no`) REFERENCES `purchase_order` (`po_no`),
  CONSTRAINT `purchase_invoice_ibfk_3` FOREIGN KEY (`grn_no`) REFERENCES `purchase_receipt` (`grn_no`)
