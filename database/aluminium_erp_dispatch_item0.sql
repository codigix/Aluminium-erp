...
CREATE TABLE `dispatch_item` (
  ...
  `packed_quantity` int DEFAULT NULL,
  `batch_number` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `idx_dispatch_id` (`dispatch_id`),
  CONSTRAINT `dispatch_item_ibfk_1` FOREIGN KEY (`dispatch_id`) REFERENCES `dispatch_order` (`dispatch_id`)
...
LOCK TABLES `dispatch_item` WRITE;
/*!40000 ALTER TABLE `dispatch_item` DISABLE KEYS */;
/*!40000 ALTER TABLE `dispatch_item` ENABLE KEYS */;
UNLOCK TABLES;
