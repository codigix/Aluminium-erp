...
CREATE TABLE `reorder_items` (
  ...
  `reorder_qty` decimal(12,2) DEFAULT NULL,
  `received_qty` decimal(12,2) DEFAULT '0.00',
  `status` enum('Pending','Ordered','Received','Cancelled') DEFAULT 'Pending',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `idx_reorder_management_id` (`reorder_management_id`),
  KEY `idx_status` (`status`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `reorder_items`
--

LOCK TABLES `reorder_items` WRITE;
/*!40000 ALTER TABLE `reorder_items` DISABLE KEYS */;
/*!40000 ALTER TABLE `reorder_items` ENABLE KEYS */;
UNLOCK TABLES;
