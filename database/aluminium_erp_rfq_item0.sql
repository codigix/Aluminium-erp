...
CREATE TABLE `rfq_item` (
  ...
  CONSTRAINT `rfq_item_ibfk_1` FOREIGN KEY (`rfq_id`) REFERENCES `rfq` (`rfq_id`),
  CONSTRAINT `rfq_item_ibfk_2` FOREIGN KEY (`item_code`) REFERENCES `item` (`item_code`)
...
INSERT INTO `rfq_item` VALUES (1,'RFQ-1761906146974','ITEM-001',100.00,'KG'),(2,'RFQ-1763719722781','ITEM-ALUMINIUMS',10.00,'Nos');
