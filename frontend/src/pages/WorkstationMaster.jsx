...
import { Card, StatusBadge, FormControl } from '../components/ui.jsx';
...
const WorkstationMaster = ({ showForm, setShowForm }) => {
  ...
  return (
    <div className="space-y-8 pb-20">
        ...
        <Card>
          <div className="bg-indigo-600 -mx-8 -mt-8 px-8 py-4 rounded-t-[32px] mb-8">
            <h2 className="text-lg font-bold text-white flex items-center gap-2">
              <span>🏭</span>
              {isEditing ? "Edit Workstation" : "Create Workstation"}
            </h2>
            <p className="text-indigo-100 text-xs mt-1">Set up and configure manufacturing workstation details</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-10">
            ...
            <section className="space-y-6">
              <div className="flex items-center gap-2 border-b border-slate-100 pb-3">
                ...
                <h3 className="text-[11px] font-bold text-slate-500 uppercase tracking-[0.2em]">Basic Information</h3>
              </div>
            ...
            <section className="space-y-6">
              <div className="flex items-center gap-2 border-b border-slate-100 pb-3">
                ...
                <h3 className="text-[11px] font-bold text-slate-500 uppercase tracking-[0.2em]">Capacity & Performance</h3>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
            ...
            <section className="space-y-6">
              <div className="flex items-center gap-2 border-b border-slate-100 pb-3">
                ...
                <h3 className="text-[11px] font-bold text-slate-500 uppercase tracking-[0.2em]">Equipment Information</h3>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
            ...
            <section className="space-y-6">
              <div className="flex items-center gap-2 border-b border-slate-100 pb-3">
                ...
                <h3 className="text-[11px] font-bold text-slate-500 uppercase tracking-[0.2em]">Maintenance Schedule</h3>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
            ...
            <section className="space-y-6">
              <div className="flex items-center gap-2 border-b border-slate-100 pb-3">
                ...
                <h3 className="text-[11px] font-bold text-slate-500 uppercase tracking-[0.2em]">Operations & Assignment</h3>
              </div>
            ...
            <section className="space-y-6">
              <div className="flex items-center gap-2 border-b border-slate-100 pb-3">
                ...
                <h3 className="text-[11px] font-bold text-slate-500 uppercase tracking-[0.2em]">Details & Notes</h3>
              </div>
            ...
            <div className="flex justify-end gap-3 pt-8 border-t border-slate-100">
              ...
              <button
                type="submit"
                className="px-8 py-2.5 rounded-xl bg-cyan-500 hover:bg-cyan-600 text-white text-sm font-bold shadow-lg shadow-cyan-100 transition-all flex items-center gap-2"
              >
                <span>💾</span>
      ...
      {/* List Section */}
      <Card>
        <div className="bg-indigo-900 -mx-8 -mt-8 px-8 py-5 rounded-t-[32px] mb-6 flex justify-between items-center">
          <div>
            <h2 className="text-lg font-bold text-white flex items-center gap-2">
              <span>📋</span>
              Workstation Inventory
            </h2>
            <p className="text-indigo-200 text-xs mt-1">Total {workstations.length} workstations configured</p>
          </div>
          <div className="flex items-center gap-4">
            <button
              ...
              className="flex items-center gap-2 px-5 py-2.5 bg-white text-indigo-900 rounded-xl text-sm font-bold shadow-sm hover:bg-indigo-50 transition-all active:scale-95"
            >
              <span className="text-lg">{showForm ? '×' : '+'}</span>
              {showForm ? 'Hide Form' : 'Add Workstation'}
            </button>
            <div className="relative w-64">
              <span className="absolute left-3 top-2.5 text-indigo-300 text-xs">🔍</span>
              <input
                type="text"
                placeholder="Search inventory..."
                className="w-full pl-10 pr-4 py-2 bg-indigo-800/50 border border-indigo-700/50 rounded-xl text-xs text-white placeholder-indigo-300 focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-all"
                value={searchTerm}
        ...
        <div className="overflow-x-auto -mx-8">
          <table className="min-w-full divide-y divide-slate-100">
            <thead className="bg-slate-50/50">
              <tr>
                <th className="px-8 py-4 text-left text-[10px] font-bold text-slate-400 uppercase tracking-widest">ID Code</th>
                <th className="px-8 py-4 text-left text-[10px] font-bold text-slate-400 uppercase tracking-widest">Workstation / Location</th>
                <th className="px-8 py-4 text-left text-[10px] font-bold text-slate-400 uppercase tracking-widest">Classification</th>
                <th className="px-8 py-4 text-center text-[10px] font-bold text-slate-400 uppercase tracking-widest">Metric (Units/hr)</th>
                <th className="px-8 py-4 text-center text-[10px] font-bold text-slate-400 uppercase tracking-widest">Hourly Rate</th>
                <th className="px-8 py-4 text-center text-[10px] font-bold text-slate-400 uppercase tracking-widest">Target</th>
                <th className="px-8 py-4 text-center text-[10px] font-bold text-slate-400 uppercase tracking-widest">Status</th>
                ...
                filteredWorkstations.map((ws) => (
                  <tr key={ws.id} className="group hover:bg-slate-50/80 transition-colors">
                    <td className="px-8 py-5">
                      <span className="px-2.5 py-1 bg-slate-100 text-slate-600 rounded-lg text-[10px] font-black group-hover:bg-white group-hover:shadow-sm transition-all border border-slate-200/50 uppercase tracking-tighter">
                        {ws.workstation_code}
                      </span>
                    </td>
                    <td className="px-8 py-5">
                    ...
                    <td className="px-8 py-5">
                      <div className="text-xs text-slate-700 font-bold">{ws.workstation_type}</div>
                      <div className="text-[10px] text-indigo-500 font-black uppercase tracking-wider">{ws.department}</div>
                    </td>
                    ...
                    <td className="px-8 py-5 text-center font-black text-indigo-600 text-xs">
