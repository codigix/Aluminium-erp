        ...
        {showForm && (
          <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50">
            <div className="bg-white rounded-lg shadow-lg max-w-2xl w-full max-h-[90vh] overflow-y-auto">
              <div className="sticky top-0 bg-blue-50 border-b border-blue-200 px-6 py-4 flex justify-between items-center">
                <div>
              ...
              <form onSubmit={handleAddVendor} className="p-6 space-y-6">
                <div>
                  ...
                  <div className="space-y-4">
                    <div>
                      <label className="block text-xs font-semibold text-slate-900 mb-2">Vendor Name <span className="text-red-500">*</span></label>
                      <input
                        type="text"
                    ...
                    <div>
                      <label className="block text-xs font-semibold text-slate-900 mb-2">Contact Person</label>
                      <input
                        type="text"
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        <label className="block text-xs font-semibold text-slate-900 mb-2">Category</label>
                        <input
                          type="text"
                      ...
                      <div>
                        <label className="block text-xs font-semibold text-slate-900 mb-2">Vendor Type <span className="text-red-500">*</span></label>
                        <select
                    ...
                    <div>
                      <label className="block text-xs font-semibold text-slate-900 mb-2">Status</label>
                      <select
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        <label className="block text-xs font-semibold text-slate-900 mb-2">Email</label>
                        <input
                          type="email"
                      ...
                      <div>
                        <label className="block text-xs font-semibold text-slate-900 mb-2">Phone</label>
                        <input
                          type="tel"
                    ...
                    <div>
                      <label className="block text-xs font-semibold text-slate-900 mb-2">Address</label>
                      <textarea
                ...
                <div>
                  ...
                  <div>
                    <label className="block text-xs font-semibold text-slate-900 mb-2">Initial Rating (0-5)</label>
                ...
                <div className="flex gap-3 justify-end pt-6 border-t border-slate-200">
                  <button
                    type="button"
                    onClick={() => setShowForm(false)}
                    className="px-4 py-2 border border-slate-200 rounded-lg text-sm font-semibold text-slate-900 hover:bg-slate-50"
                  >
                    Cancel
                  </button>
                  <button
            ...
            {filteredVendors.map((vendor) => (
              ...
              >
                <div className="flex justify-between items-start mb-3">
                  <div className="flex-1">
                    <h3 className="font-semibold text-slate-900 text-sm">{vendor.vendor_name}</h3>
                ...
                <div className="grid grid-cols-3 gap-3 mb-4">
                  <div className="text-center p-2 bg-slate-50 rounded">
                    ...
                    <p className="font-semibold text-slate-900">{vendor.total_orders || 0}</p>
                  </div>
                  <div className="text-center p-2 bg-slate-50 rounded">
                    <p className="text-xs text-slate-500 mb-1">Value</p>
                    <p className="font-semibold text-slate-900">₹{(vendor.total_value || 0).toLocaleString('en-IN')}</p>
                  </div>
                  <div className="text-center p-2 bg-slate-50 rounded">
                    <p className="text-xs text-slate-500 mb-1">Last Order</p>
                    <p className="font-semibold text-slate-900">{vendor.last_order_date ? new Date(vendor.last_order_date).toLocaleDateString('en-IN', {day: '2-digit', month: 'short'}) : 'N/A'}</p>
                  </div>
                </div>
