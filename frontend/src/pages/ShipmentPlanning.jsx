      ...
      render: (_, shipment) => (
        <div className="flex justify-end gap-2">
          ...
          <button
            ...
            className="p-1.5 bg-indigo-50 text-indigo-600 rounded  hover:bg-indigo-100 transition-all border border-indigo-100 text-xs "
          >
          ...
          {shipment.shipment_status === 'PLANNING' && (
            <button
              ...
              className="p-1.5 bg-emerald-50 text-emerald-600 rounded  hover:bg-emerald-100 transition-all border border-emerald-100 text-xs "
            >
              Mark Ready
            </button>
          )}
  ...
  return (
    <div className="p-2 space-y-2 bg-white/50 min-h-screen">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-2">
        <div>
          <h1 className="text-xl  text-slate-900">Shipment Planning</h1>
      ...
      <Modal
        ...
        size="4xl"
      >
        <form onSubmit={handleSavePlan} className="space-y-2 p-2">
          <div className="bg-slate-50 p-2 rounded border border-slate-100 space-y-2 mb-6">
          ...
          <div className="flex justify-end gap-2 pt-4 border-t border-slate-100">
            <button
              ...
              className="px-6 py-2 rounded text-xs  text-slate-500 hover:bg-slate-50 transition-colors"
            >
              Cancel
            </button>
            <button
              ...
              className="px-8 py-2 bg-indigo-600 text-white rounded text-xs  hover:bg-indigo-700 transition-all  shadow-indigo-100 flex items-center gap-2 disabled:opacity-50"
            >
              {planLoading ? 'Saving...' : (
                <>
              ...
              <table className="w-full text-left">
                <thead className="bg-slate-50/50">
                  <tr className="text-xs  text-slate-500   border-b border-slate-100">
                    ...
                    <th className=" p-2 text-center">Ready Qty</th>
                ...
                <tbody className="divide-y divide-slate-50">
                  {viewOrder.items?.map((item, idx) => (
                    <tr key={idx} className="hover:bg-slate-50/50 transition-colors">
                      ...
                      <td className=" p-2 text-center  text-slate-400 text-xs ">{item.unit || 'Nos'}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
