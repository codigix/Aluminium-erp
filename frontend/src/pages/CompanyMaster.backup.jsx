        ...
        <div className="px-8 pb-8 pt-6 space-y-3">
          ...
          <div className="rounded-2xl border border-slate-200/70 p-5">
            <div className="grid gap-6 lg:grid-cols-2">
              ...
              <div className="space-y-3">
                <p className="text-[0.6rem]  tracking-[0.35em] text-slate-400 ">Shipping Address</p>
                {['line1', 'line2', 'city', 'state', 'pincode', 'country'].map(field => (
                  <input
    ...
    <Card id="company-master" title="Company Directory" subtitle="Master List">
      {companies.length ? (
            ...
            <tbody className="divide-y divide-slate-100">
              {companies.map(company => (
                <tr key={company.id} className="hover:bg-slate-50/70">
                  ...
                  <td className="p-2 text-slate-600  align-middle">{company.gstin || '—'}</td>
        ...
        <div className="p-12 text-center space-y-3">
          ...
          <p className="text-xs text-slate-500">Use “+ New Company” to create your first company master record.</p>
        </div>
      )}
    </Card>
  </>
