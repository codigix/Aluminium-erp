...
import { Mail, Loader2, ChevronRight, MinusCircle, Eye, Send } from 'lucide-react'
                          ...
                          <tr className="hover:bg-slate-50 transition-colors cursor-pointer" onClick={() => setExpandedQuoteKey(isExpanded ? null : group.uniqueKey)}>
                            ...
                            <td className="p-2">
                              <div className="flex flex-col">
                                <span className="text-slate-400 text-xs  font-normal">Incl. GST (18%)</span>
                                <span className="text-xs text-emerald-600 ">{formatCurrency(group.total_amount * 1.18)}</span>
                              </div>
                            </td>
                            <td className="p-2 text-center">
                              <span className={`inline-flex p-1  rounded  text-[0.6rem]    ${
