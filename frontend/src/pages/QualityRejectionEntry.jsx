                ...
                <tr key={record.id} className="hover:bg-slate-50/50 transition-colors">
                  ...
                  <td className="px-3 py-2 text-right">
                    <button 
                      ...
                      className="px-3 py-1 bg-emerald-600 text-white rounded-md text-xs   hover:bg-emerald-700 transition-all shadow-sm active:scale-95 flex items-center gap-1 ml-auto"
                    >
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left border-collapse min-w-[800px]">
            <thead>
              <tr className="bg-slate-50 border-b border-slate-100">
                <th className="px-3 py-2 text-xs   text-slate-500 uppercase tracking-wider">Job Card ID</th>
                <th className="px-3 py-2 text-xs   text-slate-500 uppercase tracking-wider">Date</th>
                <th className="px-3 py-2 text-xs   text-slate-500 uppercase tracking-wider">Operation</th>
                <th className="px-3 py-2 text-xs   text-slate-500 uppercase tracking-wider text-center">Produced</th>
                <th className="px-3 py-2 text-xs   text-slate-500 uppercase tracking-wider text-center">Accepted</th>
                <th className="px-3 py-2 text-xs   text-slate-500 uppercase tracking-wider text-center text-rose-600">Rejected</th>
                <th className="px-3 py-2 text-xs   text-slate-500 uppercase tracking-wider">Reason</th>
                <th className="px-3 py-2 text-xs   text-slate-500 uppercase tracking-wider text-center">Status</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-slate-100">
