...
CREATE TABLE `bom` (
    ...
    INDEX `idx_drawing_no`(`drawing_no` ASC),
    INDEX `idx_item_code`(`item_code` ASC),
    PRIMARY KEY (`id` ASC)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `bom_approval_history` (
    ...
    INDEX `sales_order_id`(`sales_order_id` ASC),
...
CREATE TABLE `bom_items` (
    ...
    INDEX `idx_bom_id`(`bom_id` ASC),
    INDEX `idx_component_code`(`component_code` ASC),
    PRIMARY KEY (`id` ASC)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `companies` (
    ...
    UNIQUE INDEX `company_code`(`company_code` ASC),
    PRIMARY KEY (`id` ASC)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `customer_ledger` (
    ...
    INDEX `idx_customer_date`(`customer_id` ASC, `ledger_date` ASC),
    INDEX `idx_reference`(`reference_doc_id` ASC, `reference_doc_type` ASC),
    PRIMARY KEY (`id` ASC)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `customer_payments` (
    ...
    INDEX `bank_account_id`(`bank_account_id` ASC),
    INDEX `created_by`(`created_by` ASC),
    INDEX `idx_customer_date`(`customer_id` ASC, `payment_date` ASC),
    INDEX `idx_status`(`status` ASC),
    UNIQUE INDEX `payment_receipt_no`(`payment_receipt_no` ASC),
    PRIMARY KEY (`id` ASC)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `customer_po_item_subassemblies` (
    ...
    INDEX `po_item_id`(`po_item_id` ASC),
    PRIMARY KEY (`id` ASC)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `customer_po_items` (
    ...
    INDEX `customer_po_id`(`customer_po_id` ASC),
    PRIMARY KEY (`id` ASC)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `customer_pos` (
    ...
    INDEX `company_id`(`company_id` ASC),
    INDEX `requesting_department_id`(`requesting_department_id` ASC),
    PRIMARY KEY (`id` ASC)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `delivery_challan_items` (
    ...
    INDEX `challan_id`(`challan_id` ASC),
    PRIMARY KEY (`id` ASC)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `delivery_challans` (
    ...
    UNIQUE INDEX `challan_number`(`challan_number` ASC),
    INDEX `customer_id`(`customer_id` ASC),
    INDEX `shipment_id`(`shipment_id` ASC),
    PRIMARY KEY (`id` ASC)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `design_orders` (
    ...
    UNIQUE INDEX `design_order_number`(`design_order_number` ASC),
    INDEX `sales_order_id`(`sales_order_id` ASC),
    PRIMARY KEY (`id` ASC)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `grn_excess_approvals` (
    ...
    INDEX `grn_item_id`(`grn_item_id` ASC),
    INDEX `idx_grn_excess_status`(`status` ASC),
    PRIMARY KEY (`id` ASC)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `grn_items` (
    ...
    INDEX `fk_grn_items_warehouse`(`warehouse_id` ASC),
    INDEX `grn_id`(`grn_id` ASC),
    INDEX `idx_grn_items_status`(`status` ASC),
    PRIMARY KEY (`id` ASC)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `grns` (
    ...
    INDEX `idx_po_number`(`po_number` ASC),
    INDEX `idx_po_number_grn`(`po_number` ASC),
    INDEX `idx_status`(`status` ASC),
    PRIMARY KEY (`id` ASC)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `inventory` (
    ...
    INDEX `idx_item_code`(`item_code` ASC),
    INDEX `idx_stock`(`stock_on_hand` ASC),
...
CREATE TABLE `inventory_postings` (
    ...
    INDEX `idx_inventory_postings_type`(`posting_type` ASC),
    INDEX `idx_posting_type`(`posting_type` ASC),
...
CREATE TABLE `inward_challan_items` (
    ...
    INDEX `inward_challan_id`(`inward_challan_id` ASC),
    PRIMARY KEY (`id` ASC)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `inward_challans` (
    ...
    UNIQUE INDEX `inward_number`(`inward_number` ASC),
    INDEX `job_card_id`(`job_card_id` ASC),
    INDEX `outward_challan_id`(`outward_challan_id` ASC),
...
CREATE TABLE `item_groups` (
    ...
    UNIQUE INDEX `item_groups_itemsPublic_id_key`(`itemsPublic_id` ASC),
    UNIQUE INDEX `name`(`name` ASC),
    PRIMARY KEY (`id` ASC)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `job_card_inward_item_rates` (
    ...
    INDEX `quality_log_id`(`quality_log_id` ASC),
    PRIMARY KEY (`id` ASC)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `job_cards` (
    ...
    UNIQUE INDEX `job_card_no`(`job_card_no` ASC),
    INDEX `operation_id`(`operation_id` ASC),
    INDEX `work_order_id`(`work_order_id` ASC),
...
CREATE TABLE `material_issues` (
    ...
    UNIQUE INDEX `issue_number`(`issue_number` ASC),
    INDEX `issued_by`(`issued_by` ASC),
    INDEX `work_order_id`(`work_order_id` ASC),
    PRIMARY KEY (`id` ASC)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `material_requests` (
    ...
    UNIQUE INDEX `mr_number`(`mr_number` ASC),
...
CREATE TABLE `operation_workstations` (
    ...
    INDEX `workstation_id`(`workstation_id` ASC),
    PRIMARY KEY (`operation_id` ASC, `workstation_id` ASC)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `operations` (
    ...
    UNIQUE INDEX `operation_code`(`operation_code` ASC),
    INDEX `workstation_id`(`workstation_id` ASC),
    PRIMARY KEY (`id` ASC)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `orders` (
    ...
    INDEX `idx_quotation`(`quotation_id` ASC),
    UNIQUE INDEX `order_no`(`order_no` ASC),
    PRIMARY KEY (`id` ASC)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `payment_receipts` (
    ...
    INDEX `idx_customer_date`(`customer_id` ASC, `receipt_date` ASC),
    INDEX `payment_id`(`payment_id` ASC),
    UNIQUE INDEX `receipt_no`(`receipt_no` ASC),
    PRIMARY KEY (`id` ASC)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `payment_vouchers` (
    ...
    INDEX `payment_id`(`payment_id` ASC),
    INDEX `payment_vouchers_vendor_id_fk`(`vendor_id` ASC),
    UNIQUE INDEX `voucher_no`(`voucher_no` ASC),
    PRIMARY KEY (`id` ASC)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `payments` (
    ...
    INDEX `fk_payment_quality_log`(`job_card_quality_log_id` ASC),
    UNIQUE INDEX `payment_voucher_no`(`payment_voucher_no` ASC),
    INDEX `payments_vendor_fk`(`vendor_id` ASC),
    INDEX `po_id`(`po_id` ASC),
    PRIMARY KEY (`id` ASC)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `procurement_rfqs` (
    ...
    INDEX `mr_id`(`mr_id` ASC),
    INDEX `requested_by`(`requested_by` ASC),
    UNIQUE INDEX `rfq_number`(`rfq_number` ASC),
    PRIMARY KEY (`id` ASC)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `product_types` (
    ...
    UNIQUE INDEX `product_types_name_key`(`name` ASC),
    PRIMARY KEY (`id` ASC)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `production_plan_items` (
    ...
    INDEX `sales_order_id`(`sales_order_id` ASC),
    INDEX `sales_order_item_id`(`sales_order_item_id` ASC),
    INDEX `workstation_id`(`workstation_id` ASC),
    PRIMARY KEY (`id` ASC)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `production_plans` (
    ...
    INDEX `created_by`(`created_by` ASC),
    UNIQUE INDEX `plan_code`(`plan_code` ASC),
    PRIMARY KEY (`id` ASC)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `purchase_order_items` (
    ...
    INDEX `idx_purchase_order_id`(`purchase_order_id` ASC),
    PRIMARY KEY (`id` ASC)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `purchase_orders` (
    ...
    INDEX `idx_quotation_id`(`quotation_id` ASC),
    INDEX `idx_status`(`status` ASC),
    INDEX `idx_vendor_id`(`vendor_id` ASC),
    UNIQUE INDEX `po_number`(`po_number` ASC),
    INDEX `sales_order_id`(`sales_order_id` ASC),
    PRIMARY KEY (`id` ASC)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `qc_inspection_items` (
    ...
    INDEX `grn_item_id`(`grn_item_id` ASC),
    INDEX `qc_inspection_id`(`qc_inspection_id` ASC),
    INDEX `warehouse_id`(`warehouse_id` ASC),
    PRIMARY KEY (`id` ASC)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `quotation_communications` (
    ...
    INDEX `idx_quotation`(`quotation_id` ASC, `quotation_type` ASC),
    PRIMARY KEY (`id` ASC)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `quotation_requests` (
    ...
    INDEX `company_id`(`company_id` ASC),
    INDEX `fk_quotation_parent`(`parent_id` ASC),
    INDEX `sales_order_id`(`sales_order_id` ASC),
    PRIMARY KEY (`id` ASC)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `quotations` (
    ...
    UNIQUE INDEX `base_quote_version`(`base_quote_number` ASC, `version` ASC),
    INDEX `fk_quotations_mr`(`mr_id` ASC),
    INDEX `idx_rfq_group_id`(`rfq_group_id` ASC),
    INDEX `idx_sales_order_id`(`sales_order_id` ASC),
    INDEX `idx_status`(`status` ASC),
    INDEX `idx_vendor_id`(`vendor_id` ASC),
    INDEX `rfq_id`(`rfq_id` ASC),
    PRIMARY KEY (`id` ASC)
...
CREATE TABLE `role_permissions` (
    ...
    UNIQUE INDEX `unique_role_permission`(`role_id` ASC, `permission_id` ASC),
    PRIMARY KEY (`id` ASC)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `sales_orders` (
    ...
    INDEX `company_id`(`company_id` ASC),
    INDEX `customer_po_id`(`customer_po_id` ASC),
    INDEX `idx_current_department`(`current_department` ASC),
    INDEX `idx_status`(`status` ASC),
    PRIMARY KEY (`id` ASC)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `shapes` (
    ...
    UNIQUE INDEX `name`(`name` ASC),
    UNIQUE INDEX `shapes_public_id_key`(`public_id` ASC),
    PRIMARY KEY (`id` ASC)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `shipment_order_items` (
    ...
    INDEX `shipment_order_id`(`shipment_order_id` ASC),
    PRIMARY KEY (`id` ASC)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `shipment_orders` (
    ...
    INDEX `customer_id`(`customer_id` ASC),
    UNIQUE INDEX `shipment_code`(`shipment_code` ASC),
    INDEX `shipment_orders_ibfk_1`(`sales_order_id` ASC),
    PRIMARY KEY (`id` ASC)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `shipment_returns` (
    ...
    UNIQUE INDEX `return_code`(`return_code` ASC),
    INDEX `shipment_id`(`shipment_id` ASC),
    PRIMARY KEY (`id` ASC)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `stock_balance` (
    ...
    INDEX `idx_item_code`(`item_code` ASC),
    UNIQUE INDEX `unique_item_warehouse`(`item_code` ASC, `warehouse` ASC),
    PRIMARY KEY (`id` ASC)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `stock_entries` (
    ...
    INDEX `created_by`(`created_by` ASC),
    UNIQUE INDEX `entry_no`(`entry_no` ASC),
    INDEX `from_warehouse_id`(`from_warehouse_id` ASC),
    INDEX `grn_id`(`grn_id` ASC),
    INDEX `to_warehouse_id`(`to_warehouse_id` ASC),
    PRIMARY KEY (`id` ASC)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `stock_entry_items` (
    ...
    INDEX `stock_entry_id`(`stock_entry_id` ASC),
    PRIMARY KEY (`id` ASC)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `stock_ledger` (
    ...
    INDEX `created_by`(`created_by` ASC),
    INDEX `idx_item_code`(`item_code` ASC),
    INDEX `idx_qc_id`(`qc_id` ASC),
    INDEX `idx_transaction_date`(`transaction_date` ASC),
    INDEX `idx_transaction_type`(`transaction_type` ASC),
    UNIQUE INDEX `unique_grn_ledger`(`reference_doc_id` ASC, `grn_item_id` ASC, `transaction_type` ASC),
    PRIMARY KEY (`id` ASC)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `users` (
    ...
    UNIQUE INDEX `public_id`(`public_id` ASC),
    UNIQUE INDEX `public_id_2`(`public_id` ASC),
...
CREATE TABLE `vendor_ledger` (
    ...
    INDEX `vendor_ledger_vendor_id_fk`(`vendor_id` ASC),
    PRIMARY KEY (`id` ASC)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `vendors` (
    ...
    INDEX `idx_status`(`status` ASC),
    UNIQUE INDEX `vendor_code`(`vendor_code` ASC),
    UNIQUE INDEX `vendors_public_id_key`(`public_id` ASC),
    PRIMARY KEY (`id` ASC)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `warehouse_allocations` (
    ...
    INDEX `allocated_by`(`allocated_by` ASC),
    INDEX `grn_item_id`(`grn_item_id` ASC),
    PRIMARY KEY (`id` ASC)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `warehouses` (
    ...
    UNIQUE INDEX `warehouse_code`(`warehouse_code` ASC),
    PRIMARY KEY (`id` ASC)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `work_orders` (
    ...
    INDEX `production_plan_item_id`(`production_plan_item_id` ASC),
    INDEX `sales_order_id`(`sales_order_id` ASC),
    INDEX `sales_order_item_id`(`sales_order_item_id` ASC),
    UNIQUE INDEX `wo_number`(`wo_number` ASC),
    INDEX `workstation_id`(`workstation_id` ASC),
    PRIMARY KEY (`id` ASC)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `workstations` (
    ...
    UNIQUE INDEX `workstation_code`(`workstation_code` ASC),
    PRIMARY KEY (`id` ASC)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
-- AddForeignKey
ALTER TABLE `quotations` ADD CONSTRAINT `quotations_ibfk_4` FOREIGN KEY (`rfq_id`) REFERENCES `procurement_rfqs`(`id`) ON DELETE SET NULL ON UPDATE NO ACTION;
