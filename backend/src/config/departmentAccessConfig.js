...
const DEPARTMENT_ACCESS_RULES = {
  ...
  DESIGN_ENG: {
    ...
    allowedModules: ['dashboard', 'item-master', 'design-orders', 'drawing-master', 'bom-creation', 'bom-approval', 'bom-form'],
    permissions: [
  ...
  QUALITY: {
    ...
    canEditDocuments: [],
    canChangeStatusTo: [],
    allowedModules: ['dashboard', 'quality-dashboard', 'incoming-qc', 'in-process-qc', 'quality-rejections', 'quality-reports', 'quality-rejection-entry', 'qc-inspections'],
    permissions: [
      'ORDER_VIEW',
      'PO_VIEW',
      'COMPANY_VIEW',
  ...
  ADMIN: {
    ...
    allowedModules: ['dashboard', 'item-master', 'customer-po', 'sales-order', 'customer-drawing', 'po-material-request', 'design-orders', 'drawing-master', 'bom-creation', 'bom-approval', 'client-quotations', 'bom-form', 'project-requests', 'material-requirements', 'production-plan', 'work-order', 'job-card', 'sub-contract-challans', 'suppliers', 'quotations', 'purchase-orders', 'po-receipts', 'inventory-dashboard', 'quality-dashboard', 'accounts-dashboard', 'incoming-qc', 'grn', 'stock-entries', 'stock-ledger', 'stock-balance', 'warehouses', 'vendor-inward-challans', 'invoice-received', 'payment-processing', 'payment-history', 'payment-received', 'customer-payment-history', 'shipment-dashboard', 'shipment-orders', 'shipment-planning', 'dispatch-management', 'delivery-challan', 'shipment-tracking', 'shipment-returns', 'shipment-reports', 'quality-rejection-entry', 'project-analysis', 'oee-analysis', 'machine-analysis'],
    permissions: [
