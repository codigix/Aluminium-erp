...
router.get('/', authorize(['DESIGN_VIEW']), drawingController.listDrawings);
router.post('/', authorize(['DESIGN_MANAGE']), upload.single('file'), drawingController.createDrawing);
...
router.get('/:drawingNo/revisions', authorize(['DESIGN_VIEW']), drawingController.getDrawingRevisions);
