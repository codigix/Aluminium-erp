...
router.get('/approved', authenticate, authorize(['BOM_VIEW', 'PROD_VIEW', 'QC_VIEW']), bomController.getApprovedBOMs);
router.get('/items/:itemId', authenticate, authorize(['BOM_VIEW', 'PROD_VIEW', 'QC_VIEW']), bomController.getItemMaterials);
...
router.put('/components/:id', authenticate, authorize(['BOM_MANAGE']), bomController.updateComponent);
router.put('/operations/:id', authenticate, authorize(['BOM_MANAGE']), bomController.updateOperation);
router.put('/scrap/:id', authenticate, authorize(['BOM_MANAGE']), bomController.updateScrap);
...
router.get('/sales-order/:salesOrderId', authenticate, authorize(['BOM_VIEW', 'PROD_VIEW', 'QC_VIEW']), bomController.getBOMBySalesOrder);
