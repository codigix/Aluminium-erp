...
const qualityQueueRoutes = require('./routes/qualityQueueRoutes');
...
app.use((req, res, next) => {
  ...
  if (urlLower.includes('/uploads/')) {
    ...
    // Split case-insensitively using regex to get the relative file name in its original casing
    const parts = originalUrl.split(/\/uploads\//i);
...
privateRouter.use('/quality-queue', qualityQueueRoutes);
...
privateRouter.use('/rfqs', rfqRoutes);
privateRouter.use('/payments', paymentRoutes);
privateRouter.use('/vendor-invoices', vendorInvoiceRoutes);
privateRouter.use('/customer-payments', customerPaymentRoutes);
privateRouter.use('/bank-accounts', bankAccountRoutes);
privateRouter.use('/item-groups', itemGroupRoutes);
privateRouter.use('/shapes', shapeRoutes);
privateRouter.use('/materials', materialRoutes);
privateRouter.use('/final-qc', finalQCRoutes);
privateRouter.use('/secure-id', secureIdRoutes);
